const api_url = 
      "https://script.google.com/macros/s/AKfycbyTB1c73uToxCBPGH40B88dwVPLY1wi4pcELeWhp1vKO06CGXxknX4H-uOQp3WD8teB/exec";
...
function show(data) {
    ...
    for (let r of data.data) {{
            if (r.sender == thisUser) { 
                ...
                tab += `
                <div class="row-msg">
                        <div class="msg-field"><h1> Me </h1></div>
